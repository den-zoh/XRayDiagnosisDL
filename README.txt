...
Training the Models
        Navigate to the `model` directory within CODE to access Jupyter notebooks used for training models (the final model is packaged within the `API` directory as `cnn.pth`)